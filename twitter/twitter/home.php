	...
	<div class="nav">
		...
		<div class="nav-right">
			<ul>
				...
				<li><label class="addTweetBtn">Konu Yaz</label></li>
			</ul>
		</div><!-- nav right ends-->
				...
				<div class="tweet-wrap">
					<div class="tweet-inner">
						 ...
						 <form method="post" enctype="multipart/form-data">
							<textarea class="status" name="status" placeholder="Bişeyler Yazmak İster misin?" rows="4" cols="50"></textarea>
 						 	<div class="hash-box">
						 		<ul>
  						 		</ul>
						 	</div>
