	...
	<div class="nav-container">
		...
		<div class="nav-left">
			<ul>
				...
				<li><i class="fa fa-envelope" aria-hidden="true"></i>Mesajlar</li>
				<?php }?>
			</ul>
		</div><!-- nav left ends-->
		<div class="nav-right">
			<ul>
				...
				<li><label for="pop-up-tweet" class="addTweetBtn">Konu Aç</label></li>
					<?php }else{
							echo '<li><a href"'.BASE_URL.'index.php">Hesabın var mı? Giriş Yap!</a></li>'; 
					}
						?>
			</ul>
		</div><!-- nav right ends-->
...
<div class="profile-nav">
 <div class="profile-navigation">
	<ul>
		...
		<li>
			<a href="<?php echo BASE_URL.$profileData->username;?>/following">
				<div class="n-head">
					<a href="<?php echo BASE_URL.$profileData->username;?>/following">TAKİP ETTİKLERİN</a>
				</div>
				<div class="n-bottom">
	...
	<div class="edit-button">
		<span>
			<button class="f-btn follow-btn"  data-follow="user_id" data-user="user_id"><i class="fa fa-user-plus"></i>Takip Et! </button>
		</span>
	</div>
    </div>
</div>
