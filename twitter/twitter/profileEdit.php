  ...
  if(isset($_POST['screenName'])){
    if(!empty($_POST['screenName'])){
      ...
      if(strlen($screenName) > 20){
          $error = "İsim 6 ile 20 karakter arasında olmak zorunda !" ;
      }else if(strlen($profileBio) > 120){
        $error = "Açıklama çok uzun!" ;
      }else if(strlen($country) > 80){
        $error = "Ülke ismi çok uzun!" ;
      }else{
...
<div class="nav-container">
	...
	<div class="nav">
		<div class="nav-left">
			<ul>
				<li><a href="home.php"><i class="fa fa-home" aria-hidden="true"></i>Ana Sayfa</a></li>
				<li><a href="i/notifications"><i class="fa fa-bell" aria-hidden="true"></i>Bildirimler</a></li>
				<li><a href="i/notifications"><i class="fa fa-envelope" aria-hidden="true"></i>Mesajlar</a></li>
			</ul>
		</div>
		<!-- nav left ends-->
		<div class="nav-right">
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							...
							<li><a href="settings/account">Ayarlar</a></li>
...
<div class="profile-nav">
	<div class="profile-navigation">
		...
		<div class="edit-button">
			<span>
				<button class="f-btn" type="button" value="Cancel">İptal</button>
			</span>
			<span>
				<input type="submit" id="save" value="DEĞİŞİKLİKLERİ KAYDET">
			</span>
